...
class ModelComparisonApp(ctk.CTk):
    def __init__(self):
        ...
        self.title("Teacher(20 epoch)-Student(10 epoch) Model Comparison")
    ...
    def load_models(self):
        ...
        try:
            ...
            if os.path.exists('./models/teacher_model2010.h5'):
                self.teacher_model = tf.keras.models.load_model('./models/teacher_model2010.h5')
            ...
            if os.path.exists('./models/student_model2010.h5'):
                self.student_model = tf.keras.models.load_model('./models/student_model2010.h5')
